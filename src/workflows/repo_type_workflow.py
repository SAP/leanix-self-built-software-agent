...
from src.nodes.agents.individual_contributors_service_agent import (
    individual_contributors_service_agent,
)
...
from src.nodes.runnables.detect_deployment_signals_runnable import (
...
from src.nodes.runnables.single_purpose_repo_runnable import (
...
def generate_repo_type_workflow() -> CompiledStateGraph:
    ...
    graph.add_node(
        "single_purpose_repo_inspector_runnable", single_purpose_repo_inspector_runnable
    )
    graph.add_node("clone_repo_tool_runnable", clone_repo_tool_runnable)
    graph.add_node(
        "deployment_signals_detection_runnable", deployment_signals_detection_runnable
    )
    ...
    graph.add_node(
        "individual_contributors_service_agent", individual_contributors_service_agent
    )
    ...
    graph.add_edge(
        "individual_contributors_service_agent", "detect_tech_stack_runnable"
    )
